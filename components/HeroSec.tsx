...
const HeroSec = () => {
  return (
    <section className="relative bg-[url('/keep.jpg')] w-full h-[80vh] lg:max-w-full bg-cover bg-center flex items-center justify-center -mt-8">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-green-400/50 to-transparent z-0"></div>

      {/* Content */}
      <div className="relative w-full py-20 items-center text-center text-white tracking-tight flex flex-col justify-center z-10">
        <h1 className="px-2 font-bold text-4xl lg:text-6xl max-w-xl mb-4">
